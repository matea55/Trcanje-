...
$r = $bp->selectDB($s);
$sql = "SELECT dnevnik.opis_radnje, dnevnik.vrijeme_radnje,dnevnik.upit,dnevnik.radnja, korisnik.korisnicko_ime, uloga.naziv from dnevnik join korisnik on korisnik_id_korisnik=id_korisnik join uloga on uloga_id_uloga=id_uloga and opis_radnje='$odabran' order by vrijeme_radnje";
