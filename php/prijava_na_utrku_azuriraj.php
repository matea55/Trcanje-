...
$sql = "update prijava_na_utrku set datum_rodenja='$godina' where id_korisnik = (select id_korisnik from korisnik where korisnicko_ime='{$_SESSION["korisnik"]}') and id_utrka='$utrka'";
